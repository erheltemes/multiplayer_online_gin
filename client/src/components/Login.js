                                ...
                                <form>
                                    <div className="input-group form-group">
                                        <input
                                            ...
                                            onChange={props.handleInputChange} name="email" type="text" className="form-control " placeholder="username" 
                                        />
                                    </div>
                                    <div className="input-group form-group">
                                        <input
                                            data-cy="login-password"
                                            onChange={props.handleInputChange} name="password" type="password" className="form-control" placeholder="password" />
                                    </div>
                                    <div className="form-group">
                                        <input
                                            data-cy="login-submit"
                                            onClick={props.handleLoginSubmit} type="submit" value="Login" className="btn float-right login_btn" 
                                        />
                                    </div>
                                </form>
                            </div>
